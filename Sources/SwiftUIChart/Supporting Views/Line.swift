    ...
    public var body: some View {
        ZStack {
            if(self.showFull && self.showBackground){
                self.closedPath
                    .fill(LinearGradient(gradient: ChartColor.areaGradient, startPoint: .bottom, endPoint: .top))
            ...
            self.path
                ...
                .stroke(LinearGradient(gradient: ChartColor.lineGradient, startPoint: .leading, endPoint: .trailing) ,style: StrokeStyle(lineWidth: 3, lineJoin: .round))
                .rotationEffect(.degrees(180), anchor: .center)
                .rotation3DEffect(.degrees(180), axis: (x: 0, y: 1, z: 0))
...
struct Line_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let data = ChartData(points: [12, -230, 100, 54, -80])
        ...
        Group {
            GeometryReader { geometry in
                Line(
                    ...
                    touchLocation: .constant(touchLocation),
